...
{
    /// <inheritdoc />
    public partial class AddCreatedAtToRoutines : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    XpReward = table.Column<int>(type: "integer", nullable: false, defaultValue: 10),
                    CoinReward = table.Column<int>(type: "integer", nullable: false, defaultValue: 5),
